    ...
    <section class="module-body">
      <div class="container module-layout">
        <aside class="module-aside">
          ...
          <div class="source-box"><strong>权威信息入口</strong><small>政策、报名和考试安排请以官方最新通知为准。</small><a href="${module.source.url}" target="_blank" rel="noreferrer">${module.source.name} ↗</a></div>
        </aside>
